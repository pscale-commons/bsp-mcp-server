...
export function createServer(): McpServer {
  ...
  server.tool(
    ...
    {
      title: 'Stream engage — what people are doing at a moment: everyone’s now for today, then the fold',
