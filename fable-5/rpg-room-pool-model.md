> **Provenance copy** (fable-5 working set, copied 2026-06-10). Canonical source: `proposals/2026-06-05-in-loop-resolution.md` — if this diverges from the source, the source wins.
